  ...
  return (
    <section id="highlights" className="relative h-[calc(100vh-4rem)] bg-gradient-to-br from-white to-blue-100 w-full flex items-center justify-center px-4 py-20 pt-32 overflow-hidden">
      <div className="w-full relative h-full">
        ...
        >
          <div className="flex flex-col items-center justify-center gap-8 relative h-full">
            ...
            <button
              ...
              className="bg-blue-500 hover:bg-blue-600 text-white rounded-full p-4 shadow-lg transition flex items-center justify-center absolute right-6 top-1/2 -translate-y-1/2 z-20"
        ...
        >
          <div className="flex flex-col items-center justify-center gap-8 w-full relative h-full">
            <h2 className="text-3xl font-bold mb-2">Responsive Design Skills</h2>
            <p className="mb-4 text-lg text-gray-700 text-center max-w-4xl">
            ...
            <div className="flex flex-wrap items-end justify-center gap-6 w-full">
              <div className="flex flex-col items-center">
                <Image src="/media/macbook.png" alt="MacBook screenshot" width={384} height={240} className="w-[36rem] h-auto" />
                <span className="mt-2 text-sm text-gray-600">Desktop</span>
              </div>
              <div className="flex flex-col items-center">
                <Image src="/media/iPad Pro.png" alt="iPad Pro screenshot" width={768} height={1024} className="w-56 h-auto" />
                <span className="mt-2 text-sm text-gray-600">Tablet</span>
              </div>
              <div className="flex flex-col items-center">
                <Image src="/media/iPhone X.png" alt="iPhone X screenshot" width={375} height={812} className="w-28 h-auto" />
                <span className="mt-2 text-sm text-gray-600">Mobile</span>
              </div>
              <div className="flex flex-col items-center">
                <Image src="/media/apple watch.png" alt="Apple Watch screenshot" width={368} height={448} className="w-16 h-auto" />
            ...
            <div className="flex gap-4 mt-8 justify-center">
              <button
                ...
                className="bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition flex items-center justify-center absolute -bottom-6 left-1/2 -translate-x-1/2 z-20"
                style={{ boxShadow: "0 4px 16px rgba(0,0,0,0.15)" }}
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <button
                ...
                className="bg-gray-400 hover:bg-gray-500 text-white rounded-full p-4 shadow-lg transition flex items-center justify-center absolute left-6 top-1/2 -translate-y-1/2 z-20"
              >
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
